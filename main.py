...
from util.util import add_full_noise, add_noise, lid_term, get_output
...
if __name__ == '__main__':
    ...
    for iteration in range(args.iteration1):
        ...
        for _ in range(args.num_users):
            ...
            idxs_users = np.random.choice(range(args.num_users), 1, p=prob)
            w_locals = []
            for idx in idxs_users:
                ...
                print("Client %d done." % idx, "loss:", loss)
                ...
                LID_local = list(lid_term(local_output, local_output, args.LID_k))
